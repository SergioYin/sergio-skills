#!/usr/bin/env python3
"""Shared path/runtime helpers for weibo-reader scripts."""
...
DEFAULT_VISION_MODEL = os.environ.get("WEIBO_VISION_MODEL", "openai-codex/gpt-5.4")
...
def default_media_root() -> Path:
    return Path(os.environ.get("WEIBO_MEDIA_ROOT", openclaw_root() / "workspace" / "media" / "weibo")).expanduser()
...
def default_example_input() -> Path:
    return skill_dir() / "examples" / "sample_weibo_input.txt"
